...
})({"UByGG":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "ebd2694f52562e7c6ff090544bd2d159"; // @flow
...
},{}],"2nQVY":[function(require,module,exports) {
(function(global, factory) {
    ...
    function addEvent(eventName) {
        ...
        }, onElement = _ref.onElement, withCallback = _ref.withCallback, _ref$avoidDuplicate = _ref.avoidDuplicate, avoidDuplicate = _ref$avoidDuplicate === void 0 ? true : _ref$avoidDuplicate, _ref$once = _ref.once, once = _ref$once === void 0 ? false : _ref$once, _ref$useCapture = _ref.useCapture, useCapture = _ref$useCapture === void 0 ? false : _ref$useCapture;
    ...
    function getNextFocusElement() {
        ...
        if (newIndex > btns.length) newIndex = '1';
        var orders = [];
    ...
    var EventsHandlerAdmin = function() {
        function EventsHandlerAdmin1(el) {
            _classCallCheck(this, EventsHandlerAdmin1);
            this.handlers = [];
            this.el = el;
        }
        _createClass(EventsHandlerAdmin1, [
            {
                key: "add",
    ...
    var TouchEvents = function() {
        function TouchEvents1(el, option) {
            _classCallCheck(this, TouchEvents1);
    ...
    var ZoomImages = function() {
        function ZoomImages1(el, slide) {
            var _this = this;
            var onclose = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            _classCallCheck(this, ZoomImages1);
            this.img = el;
            this.slide = slide;
    ...
    var DragSlides = function() {
        function DragSlides1() {
            var _this = this;
            var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
            };
            _classCallCheck(this, DragSlides1);
    ...
    function slideVideo(slide, data, index, callback) {
        ...
        injectAssets(this.settings.plyr.js, 'Plyr', function() {
            ...
            if (url.match(/\.(mp4|ogg|webm|mov)$/) !== null) {
                ...
                sources[format] = url;
                for(var key in sources)if (sources.hasOwnProperty(key)) {
                    var videoFile = sources[key];
                    if (data.hasOwnProperty(key)) videoFile = data[key];
    ...
    var SlideConfigParser = function() {
        function SlideConfigParser1() {
            var slideParamas = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
            };
            _classCallCheck(this, SlideConfigParser1);
            this.defaults = {
                href: '',
                title: '',
                type: '',
        ...
        _createClass(SlideConfigParser1, [
            {
                key: "sourceType",
            ...
            {
                key: "checkSize",
                value: function checkSize(size1) {
                    return isNumber(size1) ? "".concat(size1, "px") : size1;
                }
            },
            {
                key: "sanitizeValue",
        ...
        return SlideConfigParser1;
    }();
    var Slide = function() {
        function Slide1(el, instance, index) {
        ...
        _createClass(Slide1, [
            {
                ...
                value: function setContent() {
                    ...
                    if (isFunction(settings.afterSlideLoad)) finalCallback = function finalCallback1() {
                        if (isFunction(callback)) callback();
                    ...
                    if (type === 'inline') {
                        ...
                        if (settings.draggable) new DragSlides({
                ...
                value: function descriptionEvents(desc, data) {
                    ...
                    addEvent('click', {
                        ...
                        withCallback: function withCallback(event, target) {
                            ...
                            var desc1 = closest(target, '.gslide-desc');
                            ...
                            var shortEvent = addEvent('click', {
                                onElement: [
                                    body,
                                    closest(desc1, '.gslide-description')
                                ],
                                withCallback: function withCallback1(event1, target1) {
                                    if (event1.target.nodeName.toLowerCase() !== 'a') {
                                        removeClass(body, 'gdesc-open');
                                        addClass(body, 'gdesc-closed');
                                        desc1.innerHTML = data.smallDescription;
                                        _this2.descriptionEvents(desc1, data);
                                        setTimeout(function() {
    ...
    var GlightboxInit = function() {
        function GlightboxInit1() {
            var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
            };
            _classCallCheck(this, GlightboxInit1);
        ...
        _createClass(GlightboxInit1, [
            ...
            },
            {
                ...
                value: function build() {
                    ...
                    if (isTouch$1) addClass(document.body, 'glightbox-touch');
...
},{}]},["UByGG","2nQVY"], "2nQVY", "parcelRequire13fe")

//# sourceMappingURL=gallery.4bd2d159.js.map

...
})({"1WGOc":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "1b8c8494421717771ebc366f86213ccc"; // @flow
...
},{}],"79OPJ":[function(require,module,exports) {
...
function stickyFunc(type, targetElement, btn) {
    const stickyNavFunc = function(entries, observer) {
        ...
        if (!entry.isIntersecting) {
            if (localStorage.theme !== "dark") logo.forEach((lg)=>lg.src = "/public/img/logo-dark.png"
            );
            ...
            if (btn) {
                ...
                btn.classList.add("bg-primaryLight", "dark:bg-gray-50", "dark:text-gray-800", "text-gray-50");
            }
        } else {
            ...
            if (btn) {
                btn.classList.remove("bg-primaryLight", "text-gray-50", "dark:bg-gray-50", "dark:text-gray-800");
...
const themeToggleFunc = function(light, dark) {
    ...
    if (!localStorage.getItem("theme") || localStorage.theme === "light") {
        if (entry.isIntersecting || !entry.isIntersecting) logo.forEach((lg)=>lg.src = "/public/img/logo-white.png"
        );
        ...
        if (entry.isIntersecting) logo.forEach((lg)=>lg.src = "/public/img/logo-white.png"
        );
        else logo.forEach((lg)=>lg.src = "/public/img/logo-dark.png"
        );
...
ticketBtn.addEventListener("click", ticketModal); // <!DOCTYPE html>
 // <html>
 //   <head>
...
},{}]},["1WGOc","79OPJ"], "79OPJ", "parcelRequire13fe")

//# sourceMappingURL=gallery.86213ccc.js.map
